        ...
        return(
            <Container style={{backgroundColor:'white'}}>
                ...
                <Content style={{top:20,left:7,right:7}}>
                    ...
                    <Text style={{color:'#167ED8',justifyContent:'center'}}>Send your plan fees</Text>
                    <Text style={{color:'#167ED8',fontWeight:'bold'}}>150 EGP</Text>
                    <Text style={{color:'#167ED8'}}>to our number</Text>
                    <Text style={{color:'#167ED8',fontWeight:'bold'}}>01012345678</Text>
                    <Text style={{color:'#167ED8'}}>and we will send you your code</Text>
                    </View>
